...
def extension_sm3_hash(msg, Current_V, old_message_len):
    # print(msg)
    len1 = len(msg)
    reserve1 = len1 % 64
    msg.append(0x80)
    ...
    old_group_count = round(old_message_len / 64)

    B = []
    for i in range(0, group_count - old_group_count):
        B.append(msg[(i+old_group_count)*64:(i+old_group_count+1)*64])
